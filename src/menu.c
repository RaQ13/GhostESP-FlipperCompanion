...
static const MenuCommand wifi_attack_commands[] = {
    ...
    },
    {
        .label = "Probe Flood",
        .command = "probeflood\n",
        .details_header = "Probe Request Flood",
        .details_text = "Floods the selected ap with spoofed\n"
        "probe requests. Use\n"
        "Stop Probe Flood to end.\n"
        "Range: ~50-100m\n",
    },
    {
        .label = "Stop Probe Flood",
        .command = "probeflood stop\n",
        .details_header = "Stop Probe Flood",
        .details_text = "Stops the active probe\n"
...

    {
        .label = "Bad Msg",
        .command = "badmsg\n",
        .details_header = "Malformed EAPOL Attack",
        .details_text = "Sends malformed EAPOL\n"
        "'Message 1' frames to the\n"
        "selected ap. Breaks client\n"
        "connections, works even on\n"
        "PMF/WPA3. Select ap first.\n"
        "Use Stop Bad Msg to end.\n",
    },
    {
        .label = "Stop Bad Msg",
        .command = "badmsg stop\n",
        .details_header = "Stop Bad Msg",
        .details_text = "Stops the active bad msg\n"
        "(malformed EAPOL) attack.",
    },
    {
